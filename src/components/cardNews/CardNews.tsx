...
const CardNews = ({ userName, avatar, title, createdAt, id, rating }: CardNewsProps) => {
  return (
    <div key={id} className="card">
        ...
        <Link to={`/news/${id}`}><div className="card__title">{title}</div></Link>
        <div className="card__footer">
            ...
            <div className="card__date">{createdAt}</div>
        </div>
    </div>
  )
}
